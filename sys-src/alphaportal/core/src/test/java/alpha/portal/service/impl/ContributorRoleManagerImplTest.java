...
/**
 * The Class ContributorRoleManagerImplTest.
 */
public class ContributorRoleManagerImplTest extends BaseManagerMockTestCase {
	...
	@Before
	public void setUp() {
		this.dao = this.context.mock(ContributorRoleDao.class);
		this.manager = new ContributorRoleManagerImpl(this.dao);
	}
	...
	public void testGetContributorRoleByName() {
		...
		this.context.checking(new Expectations() {
			{
				this.one(ContributorRoleManagerImplTest.this.dao)
						.getContributorRoleByName(
								this.with(Expectations.equal(name)));
			}
		});

		this.manager.getContributorRoleByName(name);
