...
public class UserExtensionDaoHibernate extends
		GenericDaoHibernate<UserExtension, Long> implements UserExtensionDao {
	...
	/**
	 * Gets the user extensions by contributor role.
	 * 
	 * @param role
	 *            the role
	 * @return the user extensions by contributor role
	...
	public List<UserExtension> getUserExtensionsByContributorRole(
		...
		return this.getHibernateTemplate().find(
				"from userextension where ? = some elements(roles)", role);
	}
}
