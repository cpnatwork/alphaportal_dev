 ...
 * $Id$
 *************************************************************************/
package alpha.portal.webapp.spring;
 ...
 * 
 * <pre>
 * &lt;bean class=&quot;alpha.portal.spring.ValidatorExtensionPostProcessor&quot;&gt;
...
public class ValidatorExtensionPostProcessor implements
	...
	/** The validation config locations. */
	...
	public void postProcessBeanFactory(
		...
		if (configurableListableBeanFactory
				.containsBean(this.validatorFactoryBeanName)) {
			...
			final MutablePropertyValues propertyValues = validatorFactoryBeanDefinition
					.getPropertyValues();
			final PropertyValue propertyValue = propertyValues
					.getPropertyValue("validationConfigLocations");

			// value is expected to be a list.
			final List existingValidationConfigLocations = (List) propertyValue
					.getValue();
			existingValidationConfigLocations
					.addAll(this.validationConfigLocations);
		}
	}
	 ...
	 *            The validator factory bean name.
	 */
	public void setValidatorFactoryBeanName(
	 ...
	 */
	public void setValidationConfigLocations(
