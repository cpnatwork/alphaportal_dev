...
<form:form commandName="userExtension" method="post" id="userRoleForm">
<div class="group">
	<ul>
    	<li>
    		<label class="desc"><fmt:message key="user.roles"/></label>
	    	<form:checkboxes path="roles" itemValue="contributorRoleId" itemLabel="name" items="${contributorRoles}" delimiter="<br/>"/> 
    	</li>
    	<li class="buttonBar bottom">
    	  <input type="submit" class="button" name="saveRoles" onclick="bCancel=false" value="<fmt:message key="button.save"/>"/>
    	</li>
	</ul>
</div>
</form:form>

<form:form commandName="user" method="post" action="userform" onsubmit="return onFormSubmit(this)" id="userForm" acceptCharset="iso-8859-1">
<form:hidden path="id"/>
